...
const absFormComponent = {
    ...
    class absFormInputController {
        static get $inject() {
            return ['$log', '$timeout', '$scope', '$interval', 'FormApi', 'UserApi', '$state', 'focus', '$stateParams', 'absFormService', '$mdMedia', 'systemSettingService'];
        }
        constructor($log, $timeout, $scope, $interval, FormApi, UserApi, $state, focus, $stateParams, absFormService, $mdMedia, systemSettingService) {
            this.$log = $log;
        ...
        $onInit() {
            ...
            this.systemSettingService.getSystemSetting().then((data) => this.isBeforeDeadline = data.isBeforeDeadline);
